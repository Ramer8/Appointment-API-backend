...
exports.updateMyAppointmentWithToken = exports.deleteAppointmentById = exports.getAllAppointmentsSuper_admin = exports.recoverAppointmentWithId = exports.showMyAppointmentsWithToken = exports.createAppointmentWithToken = void 0;
...
const deleteAppointmentById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.tokenData.userId;
        ...
        const appointmentDeleted = yield Appointment_1.Appointment.delete(appointmentToRemove);
        res.status(200).json({
            success: true,
