...
exports.app.delete("/api/users/", auth_1.auth, isSuperAdmin_1.isSuperAdmin, userController_1.deleteMoreThanOneUsers);
...
exports.app.delete("/api/appointments/:id", auth_1.auth, appointmentController_1.deleteAppointmentById); // ready
